...
namespace Operadores_logicos_entre_variaveis_numericas
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("O resultado da operação negação de " + Convert.ToString(var1, 2) + " é: " + Convert.ToString(resultadoNegacao, 2));
            ...
            Console.WriteLine("O valor " + var4 + " é maior ou igual (>=)" + var5 + " ?:" + (var4 >= var5));
            Console.WriteLine("O valor " + var4 + " é menor ou igual (<=)" + var5 + " ?:" + (var4 <= var5));
            Console.WriteLine("O valor " + var4 + " é maior ou igual (>=)" + var4 + " ?:" + (var4 >= var4));
            Console.WriteLine("O valor " + var5 + " é menor ou igual (<=)" + var5 + " ?:" + (var5 <= var5));

            //Operador igual - == 
            bool resultadoIgual = (var4 == var4);
            Console.WriteLine("O valor " + var4 + " é igual (==)" + var4 + " ?:" + resultadoIgual);
            Console.WriteLine("O valor " + var4 + " é igual (==)" + var5 + " ?:" + (var4 == var5));
